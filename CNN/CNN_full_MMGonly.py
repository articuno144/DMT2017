...
new_in = np.zeros([3,50,total_size])
new_n = np.zeros([3,50,91000])
new_nt = np.zeros([3,50,18000])
new_st = np.zeros([3,50,512])
new_tst = np.zeros([3,50,512])
...
saver.save(sess,'Saved\\CNN_MMGonly50_pretrain')
...
saver.save(sess,'Saved\\CNN50_trained')
